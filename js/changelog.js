...
window.CHANGELOG=[
  {v:'0.265',items:[
    {icon:'\ud83d\udde3\ufe0f',text:'<b>Fragen an die Hebamme per Alexa</b>: „Frage an die Hebamme: ab wann darf ich baden“ oder „Frag die Hebamme, ob …“ – die Frage steht danach im Reiter Hebamme, auf beiden verbundenen Telefonen. Dafür einmal Sprachmodell und Code im Alexa-Skill neu einspielen.',where:'Baby-Tagebuch → 🤱 Hebamme'}
  ]},
  {v:'0.264',items:[
  ...
  {v:'0.260',items:[
    ...
    {icon:'\ud83d\udcdd',text:'Im Wochenplan lässt sich jetzt auch <b>einfach Text eintragen</b> — „Pizza bestellen“, „Reste“, „bei Oma essen“. Tipp ins Suchfeld, was du vorhast, und wähle „als Notiz einplanen“. Ein Rezept lässt sich jederzeit nachträglich hinterlegen; bis dahin zählt die Notiz mit 0 kcal, steht nicht auf dem Einkaufszettel und wandert nicht ins Tagebuch. Der Plan sagt oben, wie viele Einträge noch ohne Rezept sind.',where:'📅 Wochenplan'},
    {icon:'\ud83d\udccb',text:'Ein aus dem Wochenplan angelegtes Rezept landet jetzt <b>nur noch in der Bibliothek</b>. Bisher wurde es gleichzeitig als Mahlzeit ins Tagebuch von heute gebucht — obwohl es niemand gegessen hatte. Wurde es aus dem ＋ eines Tages heraus angelegt, steht es danach direkt in diesem Slot.',where:'📅 Wochenplan → ＋ Neues Rezept'},
    {icon:'\ud83d\udd0e',text:'Beim Anlegen, Umbenennen und Importieren eines Rezepts prüft die App, ob <b>schon etwas Ähnliches</b> in der Bibliothek steht — gleicher oder ähnlicher Name, oder fast dieselben Zutaten — und fragt nach, bevor ein zweites daraus wird.',where:'📚 Rezeptbibliothek'},
    {icon:'\ud83c\udfb2',text:'„Füllen“ plant jetzt den <b>ganzen Tag auf dein Kalorienziel</b>: Frühstück, Mittag, Abend und Snack teilen sich das Ziel, und die Portionen werden nachgezogen, bis der Tag passt. Jeder Tag zeigt seine Summe gegen das Ziel. Vorher wurden nur Mittag und Abend mit Portion 1 gefüllt — Tage zwischen 900 und 3000 kcal waren die Regel.',where:'📅 Wochenplan → 🎲 Füllen'},
    {icon:'\ud83c\udf54',text:'Die Vorschläge kommen jetzt aus zwei Quellen: <b>zuerst deine Rezepte</b>, dazu <b>ganze Mahlzeiten aus deinem Tagebuch</b> — „Burger mit Pommes“ darf also vorkommen. Einzelne Lebensmittel bleiben draußen, und was zum Frühstück gegessen wurde, wird nicht als Abendessen vorgeschlagen.',where:'📅 Wochenplan → 🎲 Füllen'},
  ]},
  {v:'0.259',items:[
  ...
  {v:'0.254',items:[
    {icon:'\ud83d\udd27',text:'Ein aus dem ⋯-Blatt oder aus „Funktionen“ geöffnetes Menü ging hinter dem noch offenen Menü auf und war damit nicht bedienbar. Betroffen waren 21 von 25 Wegen — die vier, die gingen, gingen nur zufällig. Jetzt schließt sich das Blatt, bevor es etwas öffnet.',where:'überholt seit v0.256 — jetzt Mehr → \ud83e\udde9 Funktionen'},
