...
var CORE_ASSETS = ['./','index.html','picker.js','js/health-sync.js','js/baby.js','js/shopping.js','js/partner.js','js/alexa-sync.js','js/fooddb.js','js/changelog.js','js/idb-photos.js','js/zxing/zxing-reader.iife.js','js/zxing/zxing_reader.wasm','js/zxing/zxing-js.umd.min.js','manifest.json','icon.svg'];
